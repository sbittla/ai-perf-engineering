...
=========================================================================
PURPOSE
    Sweep configurations (batch size, sequence length, dtype, compile mode)
    and build the throughput-latency Pareto frontier. This is how you
    present performance results in a paper or benchmark submission.

    The curve answers: "For a given latency budget, what is the max throughput?"
