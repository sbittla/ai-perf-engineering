...
============================================================================
LEARNING GOAL
    Profile a real HuggingFace model (GPT-2) with every PyTorch profiling
    tool and learn to read each output.  This teaches you to diagnose
    slow ops in any model without touching the source code.

TOOLS USED IN THIS FILE
    1. torch.profiler         — op-level CPU + CUDA timing table
    2. torch.utils.bottleneck — quick one-command combined report
    3. NVTX range markers     — named bands in Nsight Systems timeline
    4. Chrome trace export    — visual timeline in browser
