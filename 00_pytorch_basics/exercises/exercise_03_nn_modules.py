...
# HINTS
# ─────────────────────────────────────────────────────────
# TODO 1:  nn.Linear(8, 4, bias=False)
# TODO 2:  nn.Sequential(nn.Linear(16,64), nn.ReLU(), nn.Linear(64,32), nn.ReLU(), nn.Linear(32,10))
# TODO 3:  sum(p.numel() for p in mlp.parameters())
# TODO 4:  self.linear = nn.Linear(dim, dim)
# TODO 5:  self.norm   = nn.LayerNorm(dim)
# TODO 6:  return self.norm(x + self.linear(x))
# TODO 7:  mdl.train()
# TODO 8:  mdl.eval()
# TODO 9:  torch.save(net.state_dict(), "test_model.pt")
# TODO 10: net2 = nn.Sequential(nn.Linear(4,8), nn.ReLU(), nn.Linear(8,2))
# TODO 11: net2.load_state_dict(torch.load("test_model.pt"))
# TODO 13: net3 = net3.to(DEVICE)
# TODO 14: all_on_device = all(str(p.device).startswith(DEVICE) for p in net3.parameters())
