...
z_requires_grad = z.requires_grad   # True or False
...
grad_after_zero = w.grad.item()   # should be 3.0, NOT 6.0
...
detached_req_grad = result_detached.requires_grad   # True or False
