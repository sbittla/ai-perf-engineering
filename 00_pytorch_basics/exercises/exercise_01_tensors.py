...
BEFORE THIS COURSE YOU SHOULD KNOW
    • What a tensor is and how to create one
    • How shapes, dtypes, and devices work
    • Basic math and indexing operations
    • How CPU↔GPU movement works

INSTRUCTIONS
    Each TODO block has a task. Fill in the code, then run:
