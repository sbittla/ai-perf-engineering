...
=============================================================================
LEARNING GOAL
    Learn to measure GPU performance CORRECTLY.  Most beginners use
    time.time() and get wrong results.  This exercise teaches the right
    way and introduces the tools you'll use throughout the course.

    Topics:
      1. Why time.time() is wrong for GPU code
      2. CUDA events — the correct GPU timer
      3. Warmup — why the first run is always slow
      4. torch.profiler — finding slow ops in one line
      5. Memory measurement — allocated vs reserved vs peak

INSTRUCTIONS
    Fill in every TODO, run: python exercise_05_performance_basics.py
"""
