...
====================================================================
PURPOSE:
    Read the CSV log from memory_monitor.sh and create a plot showing:
    - GPU memory usage over time
    - GPU utilisation over time
    - Annotated phases (if you note when load started/stopped)

    This is a PORTFOLIO ARTIFACT — the graph shows you understand how
    KV cache fills under load and how each optimisation helps.
