...
==================================================================
PURPOSE:
    Print a formatted comparison table summarising your optimisation
    results across all 4 projects. Fill in the results manually as you
    complete each project, or pipe results from benchmark scripts.

    This is the SUMMARY ARTIFACT for your portfolio — one table that
    shows the impact of every optimisation clearly.
